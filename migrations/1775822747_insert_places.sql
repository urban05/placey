...
VALUES
  (
    ...
    'Öffentliche Stadtteilbibliothek in Wilhelmsburg. Sie ist barrierearm erreichbar und hat Veranstaltungen',
  ...
  (
    ...
    'Offene Jugendeinrichtung für 12 bis 27 Jahre, mit Jugendcafé, Billard, Konsole, Tonstudio, Fitnessraum und Sportflächen.',
  ...
  (
    ...
    'Haus der Jugend Kirchdorf-Süd',
    'Offene Kinder und Jugendarbeit mit Freizeitangeboten, Beratung und Gruppenformaten.',
  ...
  (
    ...
    'Kulturzentrum in Wilhelmsburg mit Musik, Konzerten, Theater, Tanz, Werkstätten und Kinderkultur',
  ...
  (
    ...
    'Bildungsort im Herzen Wilhelmsburgs. Das Zentrum steht Bürgern jeden Alters und jeden Ausbildungsstandes offen.',
  ...
  (
    ...
    'Schule in Wilhelmsburg mit klar erkennbarem inklusiven Profil.',
  ...
  (
    ...
    'Emmauskirche',
    'Kirche in Wilhelmsburg mit vielfältigen Angeboten für Kinder, Jugendliche und Familien.',
  ...
  (
    ...
    'Wilhelmsburger Kirche mit diversen Angeboten, sowohl für Kinder und Jugendliche als auch für Erwachsene.',
    ST_MakePoint (10.0110426, 53.5002946),
    'twemoji:church',
    true,
    'Jungnickelstraße 21, 21109 Hamburg',
    'kreuzkirche_kirchdorf.jpg'
  ),
  (
    '2ddcb4d1-626a-42d8-a46f-1cf965a02f20',
    'Berufliche Schule ITECH Elbinsel Wilhelmsburg',
    'Inklusive Berufsschule auf der Elbinsel mit unterschiedlichsten Berufsausbildungen und Angeboten.',
